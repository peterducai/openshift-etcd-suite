...
fio --name=global1 --filename=fiotest --runtime=120 --ioengine=libaio --direct=1 --ramp_time=10 --name=read1 --iodepth=16 --readwrite=randread --numjobs=16 --blocksize=64k --offset_increment=128m --size=1G > best_1G_d4.log
...
fio --name=global1 --filename=fiotest --runtime=120 --ioengine=libaio --direct=1 --ramp_time=10 --name=read1 --iodepth=16 --readwrite=randread --numjobs=16 --blocksize=64k --offset_increment=128m --size=200M > best_200M_d4.log
...
fio --name=global5 --filename=fiotest --runtime=120 --ioengine=libaio --direct=1 --ramp_time=10 --name=read5  --numjobs=8 --readwrite=rw --rwmixread=30 --rwmixwrite=70 --iodepth=1 --blocksize=4k --size=1G > r30_w70_1G_d1.log
so7030small=$(cat r30_w70_1G_d1.log |grep IOPS|tail -1)
echo -e "$so7030small"
echo -e " "
rm r30_w70_1G_d1.log
